...
namespace s2t {
    ...
    struct MelBanksOptions {
        ...
        explicit MelBanksOptions(int numBins = 23)
            ...
            vtlnHigh(-500), debugMel(false), htkMode(false) {strcpy(customFilter, "../mel.csv");}
    };
    ...
    struct FbankOptions {
        ...
        FbankOptions(S2TConfig& config)
        {
            ...
            strcpy(frameOpts.inputAudio, config.extractor.inputAudio);
            std::cout << "Audio:" << frameOpts.inputAudio << std::endl;
            ...
            strcpy(frameOpts.windowType, config.extractor.windowType);
            ...
            strcpy(frameOpts.padMod, config.extractor.padMod);
            ...
            strcpy(melOpts.customFilter, config.extractor.customFilter);
        }
